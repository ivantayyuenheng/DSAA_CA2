...
class BuildParseTree:
    ...
    def evaluate(self, node=None):
        ...
        if node is None:
            node = self.tree  # Start from root if not provided
        ...
        if leftTree is None and rightTree is None:
            return op  # Should already be a float
